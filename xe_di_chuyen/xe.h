...
public:
	...
	void di_chuyen_xe_len(CClientDC *pDC);
	void di_chuyen_xe_xuong(CClientDC *pDC);

	void xedichuyenquaydaulen(CClientDC* pDC);
	void xedichuyenquaydauxuong(CClientDC* pDC);
	~xe();
};
