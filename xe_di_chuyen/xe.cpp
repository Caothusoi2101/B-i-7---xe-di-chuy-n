...
void xe::di_chuyen_xe_len(CClientDC* pDC)
{
	CPen* pen;
	pen = new CPen(PS_SOLID, 1, RGB(255, 255, 255));
	CPen* oldpen;
...
void xe::di_chuyen_xe_xuong(CClientDC* pDC)
{
	CPen* pen;
	pen = new CPen(PS_SOLID, 1, RGB(255, 255, 255));
	CPen* oldpen;
...
void xe::xedichuyenquaydaulen(CClientDC* pDC)
{
	CPen* pen;
	pen = new CPen(PS_SOLID, 1, RGB(255, 255, 255));
	CPen* oldpen;
...
void xe::xedichuyenquaydauxuong(CClientDC* pDC)
{
	CPen* pen;
	pen = new CPen(PS_SOLID, 1, RGB(255, 255, 255));
	CPen* oldpen;
